...
public class WebSocketTest {
    ...
    public void onMessage(String message, Session session) {
        ...
        String sendName = msgArray[2];
       
        saveSession(name, session);
        Session sendSession = map.get(sendName);
        sendToClient(sendSession,content);
    }
    ...
    public void sendToClient(Session sendSession ,String content) {
    	
    	try {
			sendSession.getBasicRemote().sendText(content);
		} catch (IOException e) {
			e.printStackTrace();
		}
